        ...
        <div class="login-student">
            ...
            <div class="login-student-form">
                <form action="<?php htmlspecialchars($_SERVER['PHP_SELF']) ?>" method="post">
                    ...
                    <p style="color:red ; margin-bottom: 20px;font-size : 18px" id="username-error"><?php
                                                                echo "$userName_error";

                                                                 ?></p>
                    <div>
                        <input name="passWord" class="login-student-form-input" type="password" placeholder="Mật khẩu : " value="<?php  echo $_POST['password'] ?>" >
                    </div>
