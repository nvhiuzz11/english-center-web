    ...
    <header>
        ...
        <nav>
            <ul>
                ...
                <li><a style="color: #0088cc;" href="../manage/manageFinance.html">Quản lý tài chính</a></li>
        ...
        <div id="Tab1" class="tabcontent">
            ...
            <div class="search-container">
                <form id="form-search" method="post" action="<?php echo htmlspecialchars($_SERVER['PHP_SELF']); ?>" style="width: 45%; margin: unset;display: inline-flex;" autocomplete="off">
                    <input type="text" name="keyword" id="keyword" placeholder="Tìm kiếm..." style="width: 70% ; border-radius: 0px; border-color:black;" value="" oninput="searchList()">
                ...
                <div style="    display: flex;align-items: center;">
                    <h3 style="margin-right:5px;      margin-left: 20px;  ">Trạng thái:</h3>
