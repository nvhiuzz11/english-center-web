	...
	<main>
			...
			<div class="modal-content-add">
				<div>
					<form id="form_add" name="form_add" method="post">
						...
						<label for="parent_name">Tên phụ huynh: <label id="lb_name_add" style="color:red; font-size:13px ; font-style: italic "></label></label>
						...
						<label for="student_add">Học sinh liên kết: <label class="lb_student_add" style="color:red; font-size:13px; font-style: italic;"></label></label>
						<br>
						...
						<button type="button" style="background-color: limegreen;" onclick="addStudent()" id="add_student">+</button>
				...
				<div class="container">
					...
					<div class="detail">
						...
						<div id="tab2" class="tabcontent">
							<button id="add-student" style="float: inline-end;border-radius: 0px;  background-color: seagreen; "> Thêm liên kết học sinh</button>
			...
			<div class="modal-content-edit">
				<div>
					<form id="form_edit" name="form_edit" method="post">
						...
						<label for="birthday">Ngày sinh:</label>
						<input type="date" id="birthday_edit" name="birthday_edit" required onchange="setAge2()"><label id="lb_birthday_edit" style="color:red; font-size:13px ; font-style: italic "></label>
		...
		<div id="modal-ques">
			...
			<div class="delete-ques2" style="max-width: 333px;">
				<img src="../assets/images/Help-icon.png" alt="" style=" width: 40px;">
				<h4>Phụ huynh đã có nhiều dữ liệu liên quan. Việc xóa sẽ ảnh hưởng đến cơ sở dữ liệu. <br> Bạn chắc chắn muốn xóa?</h4>
				<div style="display:flex ;justify-content: space-evenly;align-items: center">
